  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4" dir="rtl">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          حدث خطأ ما. يمكنك المحاولة مرة أخرى أو العودة إلى الرئيسية.
        </p>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "هيئة مكافحة الفساد الفلسطينية" },
      ...
      { name: "twitter:title", content: "المرصد الوطني لمؤشرات الفساد | هيئة مكافحة الفساد الفلسطينية" },
      { name: "twitter:description", content: "منصة وطنية فلسطينية لرصد وتحليل ونشر مؤشرات النزاهة والشفافية ومكافحة الفساد، بما يدعم صناعة القرار ويعزز الوصول إلى البيانات الرسمية." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/8567a294-9d53-4f0f-8a60-921bdb47b035/id-preview-daddef64--41f8e4af-32c4-4fc8-807a-a5dedce36be1.lovable.app-1784630798470.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/8567a294-9d53-4f0f-8a60-921bdb47b035/id-preview-daddef64--41f8e4af-32c4-4fc8-807a-a5dedce36be1.lovable.app-1784630798470.png" },
    ],
    links: [
