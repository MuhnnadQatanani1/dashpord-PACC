...
export const jobGrades: YearSeries[] = [
  { label: "رؤساء وأعضاء الهيئات المحلية والجمعيات والنقابات", y2022: 102, y2023: 89, y2024: 93, y2025: 146 },
...
export const assetDeclarations = [
  { year: "2022", distributed: 3933, received: 3269, rate: 83.1, periodic: 1507, entities: 140, cumulative: 66951 },
  { year: "2023", distributed: 3327, received: 2836, rate: 85.2, periodic: 1350, entities: 130, cumulative: 69787 },
  { year: "2024", distributed: 4504, received: 2542, rate: 56.4, periodic: 2057, entities: 33, cumulative: 72329 },
  { year: "2025", distributed: 2177, received: 2082, rate: 95.6, periodic: 1570, entities: 31, cumulative: 74411 },
];
...
export const protection = [
  { year: "2022", male: 21, female: 32, total: 32, accepted: 3, rejected: 29, appeals: 4, followUps: 66 },
  { year: "2023", male: 12, female: 15, total: 22, accepted: 0, rejected: 22, appeals: 0, followUps: 24 },
  { year: "2024", male: 24, female: 2, total: 26, accepted: 2, rejected: 26, appeals: 2, followUps: 36 },
  { year: "2025", male: 22, female: 28, total: 33, accepted: 3, rejected: 30, appeals: 1, followUps: null },
];
...
export const monitoring: YearSeries[] = [
  { label: "أخبار مرصودة على مواقع التواصل والإنترنت", y2022: null, y2023: null, y2024: 1636, y2025: 1350 },
...
export const seizedFunds: YearSeries[] = [
  { label: "المبالغ المودعة في حساب أمانات الهيئة (شيكل)", y2022: 116655, y2023: 55000, y2024: null, y2025: null },
  { label: "المبالغ المعادة إلى الخزينة العامة (شيكل)", y2022: 17212, y2023: null, y2024: null, y2025: null },
  { label: "المبالغ المعادة إلى جهات الصرف (شيكل)", y2022: 13925, y2023: 11000, y2024: null, y2025: null },
  { label: "إجمالي المبالغ المضبوطة/المعادة (شيكل)", y2022: 147792, y2023: 66000, y2024: null, y2025: null },
];
...
export const judicialActions: YearSeries[] = [
  { label: "المراسلات القضائية الموجّهة لجهات مختلفة", y2022: null, y2023: 342, y2024: 300, y2025: null },
  ...
  { label: "الجهات المخاطَبة ضمن برنامج الوقاية من مخاطر الفساد", y2022: null, y2023: 0, y2024: 14, y2025: null },
];
...
export const datasets: DatasetItem[] = [
  ...
  },
  {
    ...
    description: "عدد الملفات التحقيقية المسجَّلة سنوياً لدى الإدارة العامة للتحقيق والشكاوى المرتبطة بها.",
    updated: "2026-01-15",
    format: "CSV",
    rows: 4,
  },
  ...
  },
  {
    ...
    description: "تصنيف الملفات الواردة حسب التكييف الأولي للجرم — 16 نوع جريمة، بمجموع 1,049 ملفاً.",
    updated: "2026-01-15",
    format: "CSV",
    rows: 16,
  },
  ...
  },
  {
    ...
    description: "المتهمون المحالون، القضايا المفصولة بحكم، المدانون، وتوزيع القضايا حسب نوع الجرم.",
    updated: "2026-01-15",
    format: "CSV",
    rows: 34,
  },
  ...
  },
  {
    ...
    description: "طلبات الحماية الواردة لوحدة حماية الشهود والمبلغين مع تفصيل حسب النوع والنتيجة والتظلمات.",
    updated: "2026-01-15",
    format: "CSV",
    rows: 48,
  },
...
export const indicators: IndicatorGauge[] = [
  { id: "enf-1", category: "إنفاذ", label: "نسبة الإحالة للنيابة", value: 25, description: "نسبة الملفات المحالة للنائب العام من إجمالي الملفات الواردة عام 2025 (شيت 25)." },
  { id: "enf-2", category: "إنفاذ", label: "نسبة الحفظ", value: 78, description: "نسبة قرارات الحفظ من إجمالي الملفات الواردة عام 2025 (شيت 25)." },
  { id: "enf-3", category: "إنفاذ", label: "نسبة الإنجاز", value: 113, description: "الملفات المنجزة ÷ الواردة عام 2025 — يشمل تصريف تراكم سنوات سابقة (شيت 25)." },
  { id: "enf-4", category: "إنفاذ", label: "إنجاز نيابة جرائم الفساد", value: 122, description: "نسبة القضايا المنجزة لدى نيابة جرائم الفساد عام 2025 (شيت 7)." },
  { id: "int-1", category: "نزاهة", label: "استيفاء إقرارات الذمة 2025", value: 96, description: "الإقرارات المستلمة ÷ الموزَّعة × 100% (شيت 13)." },
  { id: "int-2", category: "نزاهة", label: "متوسط الاستيفاء 4 سنوات", value: 80, description: "المتوسط السنوي لنسبة استيفاء إقرارات الذمة المالية 2022-2025 (شيت 13)." },
  { id: "int-3", category: "نزاهة", label: "حصة الإقرارات الدورية", value: 75, description: "الإقرارات الدورية (تجديد كل 5 سنوات) من الإقرارات المستلمة عام 2025 (شيت 12ب)." },
  { id: "com-1", category: "مجتمع", label: "التبليغ الإلكتروني", value: 61, description: "حصة الوسائل والتطبيقات الإلكترونية من الشكاوى الواردة عام 2025 (شيت 31)." },
  { id: "com-2", category: "مجتمع", label: "طلبات الحماية 4 سنوات", value: 113, description: "إجمالي طلبات الحماية الواردة 2022-2025 (شيت 15 و15ب)." },
  { id: "com-3", category: "مجتمع", label: "الرصد الإلكتروني", value: 2986, description: "الأخبار المرصودة على مواقع التواصل والإنترنت في 2024 و2025 (شيت 44)." },
];

// PACC + Observatory content
export const observatoryJourney: JourneyMilestone[] = [
  { year: "قبل 2019", title: "الفكرة والتأسيس", description: "نضوج فكرة الانتقال من قياس مدركات الفساد إلى قياس مؤشراته الفعلية بالاعتماد على البيانات الرسمية." },
  { year: "2019 – 2020", title: "الاستراتيجية الوطنية", description: "اعتماد الاستراتيجية الوطنية عبر القطاعية لتعزيز النزاهة ومكافحة الفساد التي حدّدت المرصد كأحد أعمدتها." },
  { year: "31 يناير 2021", title: "إطلاق التقرير العلني الأول", description: "أطلقت هيئة مكافحة الفساد الفلسطينية التقرير العلني الأول للمرصد الوطني لمؤشرات الفساد بحضور رسمي واسع." },
  { year: "2022", title: "ترسيخ منظومة البيانات", description: "تسجيل 234 ملفاً تحقيقياً و879 شكوى وبلاغاً؛ اعتماد الجداول الإحصائية الموحّدة لأول مرة." },
  { year: "2023", title: "توسيع منظومة المؤشرات", description: "إضافة مؤشرات جديدة تشمل جرائم الفساد حسب التكييف الأولي، والشكاوى حسب مصدر التقديم ودرجة المشتكى عليه." },
  { year: "2024", title: "التدقيق ومعالجة الفجوات", description: "توحيد قائمة المقياس وتوثيق التحفظات على أرقام محددة وتصحيحها ضمن نسخ محدَّثة، ورصد بيانات غزة الاستثنائية." },
  { year: "2025", title: "قفزة الأحكام القضائية", description: "بلوغ 26 قضية مفصولة بحكم (×2 مقارنة بـ 2024) و95.6% استيفاء لإقرارات الذمة المالية." },
  { year: "الطريق أمامنا", title: "خارطة الطريق المستقبلية", description: "تطوير المرصد التفاعلي الرقمي، ربط البيانات مع الجهات الشريكة، ونشر بيانات مفتوحة بصيغ قابلة للتحليل الآلي." },
];

export const efforts: EffortItem[] = [
  { title: "بناء قاعدة البيانات الوطنية", description: "توحيد سجلات البلاغات والملفات والقضايا في قاعدة بيانات مركزية واحدة.", icon: "Database" },
  { title: "تنظيف البيانات", description: "معالجة القيم المفقودة والتناقضات وتوحيد صياغات التصنيفات.", icon: "Sparkles" },
  { title: "التحقق من صحة البيانات", description: "مقاطعة الأرقام مع النماذج الإحصائية الرسمية للإدارات المختصة.", icon: "ShieldCheck" },
  { title: "حوكمة البيانات", description: "سياسات وصلاحيات ومسارات موافقة رسمية على إصدار الأرقام.", icon: "Landmark" },
  { title: "توحيد المعايير", description: "قائمة المقياس الموحّد وقاموس مصطلحات مبني على قانون رقم 1 لسنة 2005.", icon: "Ruler" },
  { title: "تطوير المؤشرات", description: "معادلات موزونة (احتمالية × أثر) وربط المؤشرات المشتقة (شيت 25).", icon: "BarChart3" },
  { title: "تحسين التصنيفات", description: "تحديث تصنيفات القطاعات والجرائم مع تطور التشريعات والممارسات.", icon: "Layers" },
  { title: "التحوّل الرقمي", description: "من الملفات الورقية إلى نماذج إلكترونية موحّدة وتقارير ديناميكية.", icon: "Cpu" },
  { title: "تطوير النماذج الإحصائية", description: "نماذج موحّدة لوحدة الحماية والشكاوى والنيابة والمحكمة تغذّي المؤشرات.", icon: "FileText" },
  { title: "لوحات المؤشرات", description: "لوحة تفاعلية للجمهور توفّر KPIs ورسومات بيانية بلمسة زر.", icon: "LayoutDashboard" },
  { title: "تحسين الجودة", description: "مراجعات دورية تكشف التحفظات وتصحّح البيانات القديمة بشفافية.", icon: "BadgeCheck" },
  { title: "التعاون المؤسسي", description: "شراكات مع الجهاز المركزي للإحصاء والنيابة العامة والمحاكم.", icon: "Handshake" },
];
